...
var albums: [Album] = [
    ...
    tracks: [
        ...
        Track(id: 1, title: "Tim McGraw", lyric: """
...
"""),
        ...
        Track(id: 2, title: "Picture To Burn", lyric: """
...
"""),
        ...
        Track(id: 3, title: "Teardrops On My Guitar", lyric: """
Drew looks at me
...
"""),
        ...
        Track(id: 4, title: "A Place In This World", lyric: """
...
"""),
        ...
        Track(id: 5, title: "Cold As You", lyric: """
...
"""),
        ...
        Track(id: 6, title: "The Outside", lyric: """
...
"""),
        ...
        Track(id: 7, title: "Tied Together With A Smile", lyric: """
...
"""),
        ...
        Track(id: 8, title: "Stay Beautiful", lyric: """
...
"""),
        ...
        Track(id: 9, title: "Should've Said No", lyric: """
...
"""),
        ...
        Track(id: 10, title: "Mary's Song (Oh My My My)", lyric: """
...
"""),
        ...
        Track(id: 11, title: "Our Song", lyric: """
...
"""),
    ...
    Album(id: 2, image: "2", title: "Fearless", artist: "Taylor Swift", year: "2008",
    tracks: [
        
        Track(id: 1, title: "Fearless", lyric: """
...
"""),
        ...
        Track(id: 2, title: "Fifteen", lyric: """
...
"""),
        ...
        Track(id: 3, title: "Love Story", lyric: """
...
"""),
        ...
        Track(id: 4, title: "Hey Stephen", lyric: """
Mmm-mm, mm-mm
Mmm-mm, mm-mm
Mmm-mm, mm-mm, yeah
...
"""),
        ...
        Track(id: 5, title: "White Horse", lyric: """
...
"""),
        ...
        Track(id: 6, title: "You Belong With Me", lyric: """
...
"""),
        ...
        Track(id: 7, title: "Breathe", lyric: """
...
"""),
        ...
        Track(id: 8, title: "Tell Me Why", lyric: """
...
"""),
        ...
        Track(id: 9, title: "You're Not Sorry", lyric: """
...
"""),
        ...
        Track(id: 10, title: "The Way I Loved You", lyric: """
...
"""),
        ...
        Track(id: 11, title: "Forever & Always", lyric: """
Once upon a time
...
"""),
        ...
        Track(id: 12, title: "The Best Day", lyric: """
...
"""),
        ...
        Track(id: 13, title: "Change", lyric: """
...
"""),
    ...
    Album(id: 3, image: "3", title: "Speak Now", artist: "Taylor Swift", year: "2010",
    tracks: [
        
        Track(id: 1, title: "Mine", lyric: """
...
"""),
        ...
        Track(id: 2, title: "Sparks Fly", lyric: """
...
"""),
        ...
        Track(id: 3, title: "Back To December", lyric: """
...
"""),
        ...
        Track(id: 4, title: "Speak Now", lyric: """
...
"""),
        ...
        Track(id: 5, title: "Dear John", lyric: """
...
"""),
        ...
        Track(id: 7, title: "The Story Of Us", lyric: """
...
"""),
        ...
        Track(id: 8, title: "Never Grow Up", lyric: """
...
"""),
        ...
        Track(id: 9, title: "Enchanted", lyric: """
...
"""),
        ...
        Track(id: 10, title: "Better Than Revenge", lyric: """
...
"""),
        ...
        Track(id: 11, title: "Innocent", lyric: """
...
"""),
        ...
        Track(id: 12, title: "Haunted", lyric: """
...
"""),
        ...
        Track(id: 13, title: "Last Kiss", lyric: """
...
"""),
        ...
        Track(id: 14, title: "Long Live", lyric: """
...
"""),
    ...
    Album(id: 4, image: "4", title: "Red", artist: "Taylor Swift", year: "2012",
    tracks: [
        
        Track(id: 1, title: "State Of Grace", lyric: """
...
"""),
        ...
        Track(id: 3, title: "Treacherous", lyric: """
...
"""),
        ...
        Track(id: 4, title: "I Knew You Were Trouble", lyric: """
...
"""),
        ...
        Track(id: 5, title: "All Too Well", lyric: """
...
"""),
        ...
        Track(id: 7, title: "I Almost Do", lyric: """
...
"""),
        ...
        Track(id: 8, title: "We Are Never Ever Getting Back Together", lyric: """
...
"""),
        ...
        Track(id: 9, title: "Stay Stay Stay", lyric: """
...
"""),
        ...
        Track(id: 10, title: "The Last Time", lyric: """
...
"""),
        ...
        Track(id: 11, title: "Holy Ground", lyric: """
...
"""),
        ...
        Track(id: 12, title: "Sad Beautiful Tragic", lyric: """
...
"""),
        ...
        Track(id: 13, title: "The Lucky One", lyric: """
...
"""),
        ...
        Track(id: 14, title: "Everything Has Changed", lyric: """
(You good to go?)
...
"""),
        ...
        Track(id: 15, title: "Starlight", lyric: """
...
"""),
        ...
        Track(id: 16, title: "Begin Again", lyric: """
...
"""),
    ...
    Album(id: 5, image: "5", title: "1989", artist: "Taylor Swift", year: "2014",
    tracks: [
        
        Track(id: 1, title: "Welcome To New York", lyric: """
...
"""),
        ...
        Track(id: 2, title: "Blank Space", lyric: """
...
"""),
        ...
        Track(id: 4, title: "Out Of The Woods", lyric: """
Looking at it now
...
"""),
        ...
        Track(id: 5, title: "All You Had To Do Was Stay", lyric: """
(Hey, hey, hey)
(Hey, hey, hey)
(Hey, hey, hey)
(Hey, hey, hey)
...
"""),
        ...
        Track(id: 6, title: "Shake It Off", lyric: """
I stay out too late
...
"""),
        ...
        Track(id: 7, title: "I Wish You Would", lyric: """
...
"""),
        ...
        Track(id: 8, title: "Bad Blood", lyric: """
...
"""),
        ...
        Track(id: 9, title: "Wildest Dreams", lyric: """
...
"""),
        ...
        Track(id: 10, title: "How You Get The Girl", lyric: """
Oh, oh, oh
Oh, oh, oh
Oh-oh, oh-oh
...
"""),
        ...
        Track(id: 11, title: "This Love", lyric: """
Clear blue water
...
"""),
        ...
        Track(id: 12, title: "I Know Places", lyric: """
I, I, I, I, I, I, I, I-I
I, I, I, I, I, I, I, I-I
...
"""),
    ...
    Album(id: 6, image: "6", title: "reputation", artist: "Taylor Swift", year: "2017",
    tracks: [
        
        Track(id: 1, title: "...Ready For It?", lyric: """
...
"""),
        ...
        Track(id: 2, title: "End Game", lyric: """
...
"""),
        ...
        Track(id: 3, title: "I Did Something Bad", lyric: """
...
"""),
        ...
        Track(id: 4, title: "Don't Blame Me", lyric: """
...
"""),
        ...
        Track(id: 5, title: "Delicate", lyric: """
...
"""),
        ...
        Track(id: 6, title: "Look What You Made Me Do", lyric: """
...
"""),
        ...
        Track(id: 7, title: "So It Goes...", lyric: """
See you in the dark
...
"""),
        ...
        Track(id: 8, title: "Gorgeous", lyric: """
Gorgeous
...
"""),
        ...
        Track(id: 9, title: "Getaway Car", lyric: """
...
"""),
        ...
        Track(id: 10, title: "King Of My Heart", lyric: """
...
"""),
        ...
        Track(id: 11, title: "Dancing With Our Hands Tied", lyric: """
...
"""),
        ...
        Track(id: 13, title: "This Is Why We Can't Have Nice Things", lyric: """
...
"""),
        ...
        Track(id: 14, title: "Call It What You Want", lyric: """
...
"""),
        ...
        Track(id: 15, title: "New Year's Day", lyric: """
...
"""),
    ...
    Album(id: 7, image: "7", title: "Lover", artist: "Taylor Swift", year: "2019",
    tracks: [
        
        Track(id: 1, title: "I Forgot That You Existed", lyric: """
...
"""),
        ...
        Track(id: 2, title: "Cruel Summer", lyric: """
(Yeah, yeah, yeah, yeah)
...
"""),
        ...
        Track(id: 4, title: "The Man", lyric: """
...
"""),
        ...
        Track(id: 5, title: "The Archer", lyric: """
...
"""),
        ...
        Track(id: 6, title: "I Think He Knows", lyric: """
I think he knows
...
"""),
        ...
        Track(id: 7, title: "Miss Americana & The Heartbreak Prince", lyric: """
...
"""),
        ...
        Track(id: 8, title: "Paper Rings", lyric: """
The moon is high
...
"""),
        ...
        Track(id: 9, title: "Cornelia Street", lyric: """
...
"""),
        ...
        Track(id: 10, title: "Death By A Thousand Cuts", lyric: """
My, my, my, my
My, my, my, my
My, my, my, my
My, my, my, my
...
"""),
        ...
        Track(id: 11, title: "London Boy", lyric: """
...
"""),
        ...
        Track(id: 12, title: "Soon You'll Get Better", lyric: """
...
"""),
        ...
        Track(id: 13, title: "False God", lyric: """
...
"""),
        ...
        Track(id: 14, title: "You Need To Calm Down", lyric: """
...
"""),
        ...
        Track(id: 15, title: "Afterglow", lyric: """
...
"""),
        ...
        Track(id: 17, title: "It's Nice To Have A Friend", lyric: """
Ooh
Ooh
...
"""),
        ...
        Track(id: 18, title: "Daylight", lyric: """
...
"""),
    ...
    Album(id: 8, image: "8", title: "folklore", artist: "Taylor Swift", year: "2020",
    tracks: [
        
        Track(id: 1, title: "the 1", lyric: """
...
"""),
        ...
        Track(id: 2, title: "cardigan", lyric: """
...
"""),
        ...
        Track(id: 3, title: "the last great american dynasty", lyric: """
...
"""),
        ...
        Track(id: 5, title: "my tears ricochet", lyric: """
...
"""),
        ...
        Track(id: 6, title: "mirrorball", lyric: """
I want you to know
I'm a mirrorball
...
"""),
        ...
        Track(id: 9, title: "this is me trying", lyric: """
...
"""),
        ...
        Track(id: 10, title: "illicit affairs", lyric: """
...
"""),
        ...
        Track(id: 11, title: "invisible string", lyric: """
...
"""),
        ...
        Track(id: 12, title: "mad woman", lyric: """
...
"""),
        ...
        Track(id: 13, title: "epiphany", lyric: """
...
"""),
        ...
        Track(id: 17, title: "the lakes", lyric: """
...
"""),
    ...
    Album(id: 9, image: "9", title: "evermore", artist: "Taylor Swift", year: "2020",
    tracks: [
        
        Track(id: 1, title: "willow", lyric: """
...
"""),
        ...
        Track(id: 2, title: "champagne problems", lyric: """
...
"""),
        ...
        Track(id: 3, title: "gold rush", lyric: """
Gleaming, twinkling
...
"""),
        ...
        Track(id: 4, title: "'tis the damn season", lyric: """
...
"""),
        ...
        Track(id: 5, title: "tolerate it", lyric: """
...
"""),
        ...
        Track(id: 6, title: "no body, no crime", lyric: """
He did it
He did it
...
"""),
        ...
        Track(id: 7, title: "happiness", lyric: """
...
"""),
        ...
        Track(id: 8, title: "dorothea", lyric: """
...
"""),
        ...
        Track(id: 9, title: "coney island", lyric: """
...
"""),
        ...
        Track(id: 11, title: "cowboy like me", lyric: """
...
"""),
        ...
        Track(id: 12, title: "long story short", lyric: """
Fatefully
...
"""),
        ...
        Track(id: 13, title: "marjorie", lyric: """
Never be so kind
...
"""),
        ...
        Track(id: 14, title: "closure", lyric: """
...
"""),
        ...
        Track(id: 15, title: "evermore", lyric: """
Gray November
...
"""),
        ...
        Track(id: 16, title: "right where you left me", lyric: """
...
"""),
        ...
        Track(id: 17, title: "it's time to go", lyric: """
...
"""),
    ...
    Album(id: 10, image: "10", title: "Midnights", artist: "Taylor Swift", year: "2022",
    tracks: [
        
        Track(id: 1, title: "Lavender Haze", lyric: """
Meet me at midnight
...
"""),
        ...
        Track(id: 3, title: "Anti Hero", lyric: """
...
"""),
        ...
        Track(id: 4, title: "Snow On The Beach", lyric: """
...
"""),
        ...
        Track(id: 5, title: "You're On Your Own, Kid", lyric: """
...
"""),
        ...
        Track(id: 6, title: "Midnight Rain", lyric: """
Rain
...
"""),
        ...
        Track(id: 7, title: "Question...?", lyric: """
I remember
...
"""),
        ...
        Track(id: 8, title: "Vigilante Shit", lyric: """
...
"""),
        ...
        Track(id: 9, title: "Bejeweled", lyric: """
...
"""),
        ...
        Track(id: 10, title: "Labyrinth", lyric: """
...
"""),
        ...
        Track(id: 12, title: "Sweet Nothing", lyric: """
...
"""),
        ...
        Track(id: 13, title: "Mastermind", lyric: """
